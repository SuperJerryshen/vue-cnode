<template>
  <div class="publish-wrap">
    <back-bar :title="'新建文章'" class="back-bar"></back-bar>
    <div class="publish">
      <div class="new-title">
        <h2>文章标题</h2>
      ...
      <div class="content">
        <mavon-editor v-model="editorContent" ref="content" style="height: 100%" :toolbars="toolbars" :default_open="'edit'"></mavon-editor>
      </div>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    activated () {
      if (this.update) {
        this.axios.get(`https://cnodejs.org/api/v1/topic/${this.topicId}?mdrender=false`)
          .then(res => {
